table_fname = 'mismatch_nov20_100ms_baseline_preceding_mulit_window.mat';
load(table_fname);
...
save_dir = 'C:\Users\Lee\Desktop\Desktop\mvelez\mismatch_nov20_response\100ms_baseline_preceding_multi_window_test';
...
for probe_i = 1 : length(probe_fnames)
    ...
    for cluster_i = 1 : length(cluster_ids)
        ...
        for prot_i = 1 : N_PROT
            ...
            if any(p_val(:, prot_i) < 0.05/4) && is_cortical
