...
experiment = {'visual_flow', 'darkness', 'head_tilt'};  % 'darkness', 'visual_flow', 'head_tilt'
combination = {'protocols', 'protocols', 'protocols'};
...
for exp_i = 1 : length(experiment)
    ...
    [probe_fnames, protocols, ~, replay_of, ~, ~, ~, title_str, vis_stim] = experiment_details(experiment{exp_i}, combination{exp_i});
