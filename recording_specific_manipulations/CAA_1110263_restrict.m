% Get time to restrict analysis of recording CAA-1110263
%   After passing the entire recording through kilosort, we see that
%   the beginning of this recording was unstable until about 1400s.
%   So here we compute the time at which to reanalyze the recording.
%   We find the time after 1400s at which a 'batch' of protocols starts, so
...
% to get the file CAA-1110263_rec1_rec2_rec3.mat.

% load the formatted data
load('CAA-1110263_rec1_rec2_rec3.mat', 'sessions', 't_sync');
