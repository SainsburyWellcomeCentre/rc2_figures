...
save_dir = 'C:\Users\Lee\Desktop\Desktop\unity_plots\darkness\stationary_vs_motion';
save_on = true;
...
for probe_i = 1 : length(probe_fname)
    ...
    for prot_i = 1 : length(protocols)
        ...
        for clust_i = 1 : length(cluster_ids)
            ...
            c = c + 1;
            stationary_median{probe_i}{prot_i}(c) = nanmedian(stationary_rate);
            motion_median{probe_i}{prot_i}(c) = nanmedian(motion_rate);
