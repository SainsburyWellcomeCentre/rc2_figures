function figure_s5a(data, h_ax)

probe_id    = 'CA_176_1_rec1_rec2_rec3';
cluster_id  = 186;
trial_id    = 14;
bout_n      = 1;
padding     = [-3, 3];
...
traces_to_plot = {'translation'};
vertical_spacing = containers.Map({'translation'}, {30});
