function figure_s6a(data, h_ax1, h_ax2, h_ax3)
...
for ii = 1 : length(probe_ids)
    ...
    for jj = 1 : length(clusters)
        ...
        response_magnitude(end+1)   = this_data.get_mismatch_response(clusters(jj).id, trial_group_labels);
    end
end
...
plot(h_ax3, common_t, population_average-population_sem, 'color', [0.5, 0.5, 0.5], 'linewidth', 0.25);
set(h_ax3, 'ylim', [-2, 10], 'ytick', 0:5:10, 'yticklabel', {'0', '', '10'}, 'xlim', padding, 'xcolor', 'none', ...
