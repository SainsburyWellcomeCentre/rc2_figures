...
save_dir = 'C:\Users\Lee\Desktop\Desktop\mi_vs_depth_plots\darkness\vestibular';
save_on = false;
...
for probe_i = 1 : length(probe_fname)
    ...
    for clust_i = 1 : length(cluster_ids)
        ...
        fr_x = nanmedian(stationary_rate);
        fr_y = nanmedian(motion_rate);
...
l6b_i = find(strcmp('VISp6b', layers));
