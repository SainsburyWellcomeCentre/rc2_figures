classdef FileManager < handle
    ...
    methods
        ...
        function animal_list = list_animals(obj)
            ...
            contents = dir(obj.config.raw_probe_dir);
        ...
        function [fname, exists] = session_list(obj)
            ...
            fname = fullfile(obj.config.summary_data_dir, 'session_list.csv');
            exists = isfile(fname);
        end
        ...
        function [fname, exists] = processed_data_raw_ap_probe(obj, recording_id)
            ...
            level_1 = fullfile(obj.config.processed_probe_slow_dir, animal_id);
        ...
        function [fname, exists] = formatted_data(obj, recording_id)
            ...
            fname = fullfile(obj.config.formatted_data_dir, sprintf('%s.mat', recording_id));
            exists = isfile(fname);
        end
        ...
        function [dname, exists] = imec0_ks2(obj, recording_id)
            ...
            animal_id = obj.animal_id_from_recording_id(recording_id);
            level_1 = fullfile(obj.config.processed_probe_slow_dir, animal_id, 'output');
